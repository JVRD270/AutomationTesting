...
public class NotRenderedElementPage extends PageObjectBase {
	public NotRenderedElementPage(WebDriver driver, String url) {
		super(driver, url);
	}
	...
	public NotRenderedElementPage toggleElement() {
		startButton.click();
